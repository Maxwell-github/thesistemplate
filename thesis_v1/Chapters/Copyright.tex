% 头上几行空白
  ...
  本人授权{\bfseries\kaishu\zihao{4}\underline{~浙江大学~}}可以将学位论文的全部或部分内容编入有关数据库进行检索和传播，
  ...
  \else
  {\raisebox{-5mm}{\includegraphics[width=13em,height=4.6em]{./Signature/sailing_ch2.eps}}}
 %{\raisebox{-5mm}{\includegraphics[width=13em,height=4.6em]{./Signature/sign_cr_s.eps}}}
  \fi
